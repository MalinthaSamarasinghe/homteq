...
if (isset($_SESSION['userid']))
{
	...
	{ 
		...
		echo "<p style='float: right'>👤 ".$_SESSION['fname']." ".$_SESSION['sname']." | User Type: homteq Customer</p><br>";
	}
			
	if ($_SESSION['usertype']=='A' || $_SESSION['usertype']== "a") //if user type is A, they are an admin
	{ 
		//display first name and surname on the right hand-side, right under the navigation bar
		echo "<p style='float: right'>👤 ".$_SESSION['fname']." ".$_SESSION['sname']." | User type: homteq Administrator</p><br>";
	}
}
