...
country.<br>";
echo "You can either watch a live stream through your phone or tablet, or just get alerts when the motion sensor is 
triggered.<br>";

echo "<p class='updateInfo'><b>SMART ENERGY</b></p>";
echo "<p class='updateInfo'>Smart thermostat systems let you turn it off instantly from your phone – no matter where you are – or you can tell them<br>";
