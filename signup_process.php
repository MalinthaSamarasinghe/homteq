...
{
	echo "<p style='padding-left: 32px;'><b>Your Sign-up failed!</b></p>";
    echo "<br><p style='padding-left: 32px;'>All the mandatory fields need to be filled in.</p>";
    echo "<br><p style='padding-left: 32px;'>Go back to: <a href=signup.php>sign up</a></p>";
	echo "<br><br><br><br>";
} 
elseif ($password1 <> $password2) //if the 2 entered passwords do not match
{
	echo "<p style='padding-left: 32px;'><b>Your Sign-up failed!</b></p>";
    echo "<br><p style='padding-left: 32px;'>The two passwords are not matching.</p>";
    echo "<br><p style='padding-left: 32px;'>Go back to: <a href=signup.php>sign up</a></p>";
	echo "<br><br><br><br>";
}
...
{
	echo "<p style='padding-left: 32px;'><b>Your Sign-up failed!</b></p>";
    echo "<br><p style='padding-left: 32px;'>Please insert your e-mail address correctly.</p>";
    echo "<br><p style='padding-left: 32px;'>Go back to: <a href=signup.php>sign up</a></p>";
	echo "<br><br><br><br>";
}
else
{
	...
	if (mysqli_query($conn, $SQL))
	{
		...
		echo "<p style='padding-left: 32px;'><b>Sign-up Complete</b></p>";
        echo "<br><p style='padding-left: 32px;'>Go to Log in Page: <a href=login.php>login</a></p>";
	}
	//else, if the SQL execution is erroneous, there is a problem
	else
	{
		//Display sign up failure
		echo "<p style='padding-left: 32px;'><b>Sign-up failed!</b></p>";
		
		//echo "<br><p style='padding-left: 32px;'>SQL Error No: ".mysqli_errno($conn)."</p>"; //Retrieve the error number and display.
		//echo "<p style='padding-left: 32px;'>SQL Error Msg: ".mysqli_error($conn)."</p>"; //Retrieve the error message and display.
		...
		{
            echo "<br><p style='padding-left: 32px;'>An account with your e-mail is already registered.</p>";
        }
		//error code for inserting characters that is problematic for SQL query
		if (mysqli_errno($conn) == 1064) 
		{
            echo "<br><p style='padding-left: 32px;'>Invalid characters used<br>";
